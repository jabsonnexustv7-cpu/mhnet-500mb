...
(function () {
  ...
  function catalog() {
    ...
    return [
      { id: regional ? "FIBRA 600MB + 1 PONTO EXTRA DE WI-FI" : "FIBRA 500MB + 1 PONTO EXTRA DE WI-FI", title: regional ? "600 Mega + 1 Ponto extra" : "500 Mega + 1 Ponto extra", badge: "Mais popular", price: "R$ 119,90", description: "Mais cobertura de Wi-Fi pela casa com um ponto extra.", features: "Ponto extra de Wi-Fi · Instalação grátis", featured: true },
  ...
  function rewriteAssistantCopy(selection) {
    ...
    if (/tr[eê]s condi[cç][oõ]es especiais|ver mais ofertas|demais planos/i.test(text)) {
      bubble.textContent = "Escolha o plano que combina melhor com sua casa. O plano com ponto extra por R$ 119,90 é o mais popular.";
    }
  }
